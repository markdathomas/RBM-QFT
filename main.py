...
number_of_epochs = 2            #Number of different alpha values used. (Alpha = learning rate)
...
m_visible = 2               #Number of lattice sites. 
n_hidden = 2                #Number of hidden nodes used
batch_size = 200              #Number of data points used in each training set.    
steps_per_epoch = 1*10**2   #Number of steps performed in each training epoch.
double_first_epoch = False  #Perform the first run twice? (as in Cossu et al). 
